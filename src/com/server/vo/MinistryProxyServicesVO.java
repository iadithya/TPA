...
public class MinistryProxyServicesVO extends AbstractObjectValues{
	...
	public MinistryProxyServicesVO(String ministryProxyName, String eserviceId,
			String serviceName, String ministryName, String serviceType,
			boolean isWSSecurity1, boolean isWSSecurity2, 
			String endpoint1,
	...
	public MinistryProxyServicesVO() {
