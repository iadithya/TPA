...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">eServices</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                  ...
                                  <%--   
                                    <s:if test="%{allCategories.isEmpty()}">
										...
										<%-- <%int count=1; %> --%>
                                	<s:iterator value="alleservices">
                                    <tr>
                                      <%--   <td><%=count++ %></td> --%>
										<td><s:property value="eserviceName" /></td>
										<td><s:property value="minstryName" /></td>
										<%-- <td><s:property value="projectManagerName" /></td> --%>
										<td><a href="eServicesView?guid=<s:property value="%{guid}"/>" class="btn btn-outline btn-primary btn-xs">View</a></td>
										<td>
