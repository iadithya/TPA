                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <s:form role="form" action="mServiceSave" theme="simple">
                                    <s:hidden name="guid" />
                                        <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <s:textfield  cssClass="form-control" placeholder="Enter endpoint " name="endpoint" id="endpoint" onchange="urlsplit()"/>
                                             <label>isWSSecurtity</label>
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="isWSSecurity">
                                            </label>
                                        </div>
                                          <div class="form-group">
                                            <label>Service Name</label>
                                            <s:textfield cssClass="form-control" placeholder="Enter Service Name" name="serviceName" id="serviceName"/>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <s:textfield cssClass="form-control" placeholder="Enter keywords" name="keyword" id="keyword"/>
                                        </div>
...
function urlsplit(){
//	var url1 = "http://example.com/stockquote/ServiceImpl.asmx";
	var url=document.getElementById("endpoint").value
	var pieces = url.split("//");
	pieces = pieces[1].split("/");
	document.getElementById("serviceName").value= pieces[1];
	document.getElementById("keyword").value= pieces[1];
