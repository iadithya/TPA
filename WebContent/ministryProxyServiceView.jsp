...
<body>
 ...
 -->                    </ul>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Ministry Proxy Service</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           Ministry Proxy Service View 
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <s:form role="form" action="eServiceSave" theme="simple">
                                    <s:hidden name="guid" />
                                        <div class="form-group">
                                            <label>eService Name</label>
                                          <%--   <s:textfield name="eserviceName" cssClass="form-control" placeholder="Enter eService Name"  /> --%>
                                         <s:property value="eserviceName"/>
                                        </div>
                                          <div class="form-group">
                                            <label>Ministry Proxy Name</label>
                                          <%--   <s:textfield  cssClass="form-control" placeholder="Enter Ministry Name" name="minstryName" /> --%>
                                        <s:property value="ministryProxyName"/>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>End Point1</label>
                                          <%--   <s:textfield  cssClass="form-control" placeholder="Enter Ministry Name" name="minstryName" /> --%>
                                        <s:property value="endpoint_1"/>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>End Point 2</label>
                                          <%--   <s:textfield  cssClass="form-control" placeholder="Enter Ministry Name" name="minstryName" /> --%>
                                        <s:property value="endpoint_2"/>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Ministry Name</label>
                                          <%--   <s:textfield  cssClass="form-control" placeholder="Enter Ministry Name" name="minstryName" /> --%>
                                        <s:property value="ministryName"/>
                                        </div>
...
<%--                                             <s:textfield cssClass="form-control" placeholder="Enter Project Manager Name" name="projectManagerName"/>--%>
